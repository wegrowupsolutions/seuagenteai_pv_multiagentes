  ...
  return (
    ...
    <div className="neural-card neural-glow group relative overflow-hidden h-full flex flex-col">
      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <button 
          onClick={async () => {
            if (title === 'Agente PetShop' || title === 'Agência de Carros' || title === 'Agente Consultorio Dentário' || title === 'Agente Imobiliário' || title === 'Agente para Advocacia' || title === 'Agente Salão de Estética' || title === 'Agente Vendedor' || title === 'Agente Advogado' || title === 'Agente Corretor de Seguros' || title === 'Agente para Escolas') {
