...
const MobilePhone = ({ agentName, webhookUrl }: MobilePhoneProps) => {
  ...
  const getWebhookUrl = () => {
    ...
    switch (agentName) {
      ...
      case 'Agente Advogado':
        return 'https://webhook.serverwegrowup.com.br/webhook/df2d3b0d-8481-4df5-89ce-b268400a3c2e/chat';
      case 'Agente Academia':
        return 'https://webhook.serverwegrowup.com.br/webhook/df2d3b0d-8481-4df5-89ce-b268400a3c2e/chat';
      ...
      case 'Agente Corretor de Seguros':
        return 'https://webhook.serverwegrowup.com.br/webhook/8d9a4ae1-a131-42a4-9ae2-0fc14d2079ff/chat';
      case 'Agente para Escolas':
      ...
      case 'Especialista':
        return 'https://webhook.serverwegrowup.com.br/webhook/40a13009-e99c-478e-a1f6-5418a61f51dc/chat';
      case 'Agente PetShop':
      default:
